...
ACustomPlot::ACustomPlot(QWidget* widget):ThCustomPlot(widget)
{
    Initial();
...
void ACustomPlot::Initial()
{
    ...
    m_lineTracerShortLine = new XxwTraceLine(this,XxwTraceLine::ShortLine,QPen(Qt::red,2,Qt::DashLine));
