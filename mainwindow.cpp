...
void MainWindow::on_pushButton_clicked()
{
    ...
    {
        connect(ui->widget8s, &SCustomPlot::updateY1, (ui->widget8c), &CCustomPlot::updateY1Event);
        connect(ui->widget8s, &SCustomPlot::updateY2, (ui->widget8c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page11)
    {
        ...
        connect(ui->widget11s, &SCustomPlot::updateY1, (ui->widget11c), &CCustomPlot::updateY1Event);
        connect(ui->widget11s, &SCustomPlot::updateY2, (ui->widget11c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page12)//sa2bc
    {
        ...
        connect(ui->widget12s, &SCustomPlot::updateY1, (ui->widget12c), &CCustomPlot::updateY1Event);
        connect(ui->widget12s, &SCustomPlot::updateY2, (ui->widget12c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page13)//sa2bc
    {
        ...
        connect(ui->widget13s, &SCustomPlot::updateY1, (ui->widget13c), &CCustomPlot::updateY1Event);
        connect(ui->widget13s, &SCustomPlot::updateY2, (ui->widget13c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page14)
    {
        ...
        connect(ui->widget14s, &SCustomPlot::updateY1, (ui->widget14c), &CCustomPlot::updateY1Event);
        connect(ui->widget14s, &SCustomPlot::updateY2, (ui->widget14c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page16)
    {
        ...
        connect(ui->widget16s, &SCustomPlot::updateY1, (ui->widget16c), &CCustomPlot::updateY1Event);
        connect(ui->widget16s, &SCustomPlot::updateY2, (ui->widget16c), &CCustomPlot::updateY2Event);
    ...
    {
        connect(ui->widget17s, &SCustomPlot::updateY1, (ui->widget17c1), &CCustomPlot::updateY1Event);
        connect(ui->widget17s, &SCustomPlot::updateY2, (ui->widget17c1), &CCustomPlot::updateY2Event);
        connect(ui->widget17s, &SCustomPlot::updateY1, (ui->widget17c2), &CCustomPlot::updateY1Event);
        connect(ui->widget17s, &SCustomPlot::updateY2, (ui->widget17c2), &CCustomPlot::updateY2Event);
        connect(ui->widget17s, &SCustomPlot::updateY1, (ui->widget17c3), &CCustomPlot::updateY1Event);
        connect(ui->widget17s, &SCustomPlot::updateY2, (ui->widget17c3), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page18)
    {
        ...
        connect(ui->widget18s, &SCustomPlot::updateY1, (ui->widget18c), &CCustomPlot::updateY1Event);
        connect(ui->widget18s, &SCustomPlot::updateY2, (ui->widget18c), &CCustomPlot::updateY2Event);
    ...
    else if(curWidget==ui->page19)
    {
        ...
        connect(ui->widget19s, &SCustomPlot::updateY1, (ui->widget19c), &CCustomPlot::updateY1Event);
        connect(ui->widget19s, &SCustomPlot::updateY2, (ui->widget19c), &CCustomPlot::updateY2Event);
